        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-6 text-slate-900 dark:text-slate-100 font-sans">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                {stats.map((stat, index) => (
                    <Card key={index} className={`bg-white/60 dark:bg-slate-900/40 backdrop-blur-md border ${stat.border} shadow-lg relative overflow-hidden group rounded-xl`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    <Card className="bg-white/60 dark:bg-slate-900/40 backdrop-blur-md shadow-lg rounded-xl">
                        <CardHeader className="flex flex-row justify-between items-center mb-6 p-6 pb-0">
                ...
                <div className="space-y-8">
                    <Card className="bg-white/60 dark:bg-slate-900/40 backdrop-blur-md shadow-lg h-full rounded-xl">
                        ...
                        <CardContent className="grid gap-4 p-6 pt-0">
                            <Button
                                ...
                                className="h-auto w-full justify-start items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-blue-600/20 to-blue-500/10 border-blue-500/30 hover:border-blue-400 hover:from-blue-600/30 hover:bg-transparent transition-all group"
                            >
                                ...
                                <div className="text-left flex-col items-start flex">
                                    ...
                                    <span className="text-xs text-blue-700 dark:text-blue-300/70 font-normal">Registrar entrada de niño</span>
                                </div>
                            </Button>

                            <Button
                                variant="outline"
                                className="h-auto w-full justify-start items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-red-600/20 to-red-500/10 border-red-500/30 hover:border-red-400 hover:from-red-600/30 hover:bg-transparent transition-all group"
                            >
                                ...
                                <div className="text-left flex-col items-start flex">
                                    ...
                                    <span className="text-xs text-red-700 dark:text-red-300/70 font-normal">Finalizar sesión de juego</span>
                                </div>
                            </Button>
                            ...
                            <Button
                                ...
                                className="h-auto w-full justify-start items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-yellow-600/20 to-yellow-500/10 border-yellow-500/30 hover:border-yellow-400 hover:from-yellow-600/30 hover:bg-transparent transition-all group"
                            >
                                ...
                                <div className="text-left flex-col items-start flex">
                                    ...
                                    <span className="text-xs text-yellow-700 dark:text-yellow-300/70 font-normal">Snacks, calcetines, bebidas...</span>
                                </div>
                            </Button>
                        </CardContent>
